...
<html>
    <head>
        ...
        <title>Selamat Datang - Masjid At-Taqwa Poliwangi</title>
        ...
        <div class="page-content">
            <section id="featured" class="content-section">
                <div class="section-heading">
                    <h1><!--<php echo $_SESSION['username'];?>,--> Agenda Kegiatan<br><em>Masjid Al-Taqwa</em></h1>
                ...
                <div class="section-content">
                    <div class="masonry">
                        <div class="row">
                            <div class="item">
                                <div class="col-md-12">
                                    <iframe src="https://www.jadwalsholat.org/adzan/monthly.php?id=26" height="900" width="430" frameborder="0"></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
			...
			<!-- <div class="page-content"> -->
            <section id="jadwalpiket" class="content-section">
                <div class="section-heading">
                    <h1><!--<php echo $_SESSION['username'];?>,--> Jadwal Piket<br><em>Masjid Al-Taqwa</em></h1>
                    <p>Alhamdulillah, kami ucapkan terimakasih atas
                    <br>Nikmat Allah yang Maha Kuasa.</p>
                </div>
                <div class="table-responsive">
