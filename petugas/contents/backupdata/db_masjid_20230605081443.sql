...
INSERT INTO tbl_agenda VALUES("1","PT-001","kajian","19:43:00","20:44:00","2023-05-18","2023-05-18","kajian agama islam untuk mahasiswa");
INSERT INTO tbl_agenda VALUES("2","PT-001","pengajian","17:12:00","19:12:00","2023-05-20","2023-05-20","untuk anggota imam");
...
CREATE TABLE `tbl_jadwalpiket` (
  `id_jadwalpiket` int(11) NOT NULL AUTO_INCREMENT,
  `id_petugas` char(6) NOT NULL,
  `judul` varchar(200) NOT NULL,
  `jam_awal` time NOT NULL,
  `jam_akhir` time NOT NULL,
...
INSERT INTO tbl_petugas VALUES("PT-001","908070605","Ari Sumardi","Sekeloa","2147483647","petugas","$2y$10$q/vBmuqpujbweoBkZvR5TOWN0AnoqDb/1PiS.s7Bf9OjFYq07ews6","AD-001");
