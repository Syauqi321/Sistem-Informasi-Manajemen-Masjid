                 ...
                 <div class="col-lg-12">
                            <div class="box">
                                <header class="dark">
                                    ...
                                    <h5 class="text-info">Input Jadwal Piket</h5>
                                    <div class="toolbar">
                                        <ul class="nav">
                                            <li>
                                                <div class="btn-group">
                                ...
                                <div id="collapse2" class="body collapse in">
                                    <form class="form-horizontal" action="library/tambah-jadwalpiket.php" method="post" id="popup-validation">
								...
								<br><br>
									...
									<div class="table-responsive">
										<table class="table table-condesed table-bordered table-hover">
											...
											<?php
												$i = 1;
												$tampil = $koneksi->prepare("SELECT id_jadwalpiket,judul, jam_awal,jam_akhir,tgl_awal,tgl_akhir,keterangan from tbl_jadwalpiket");
												$tampil->execute();
												$tampil->store_result();
