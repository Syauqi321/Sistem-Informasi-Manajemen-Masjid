...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Bulan Mei 2023 pada 13.22
...
(1, 'PT-001', 'kajian', '19:43:00', '20:44:00', '2023-05-18', '2023-05-18', 'kajian agama islam untuk mahasiswa'),
(2, 'PT-001', 'pengajian', '17:12:00', '19:12:00', '2023-05-20', '2023-05-20', 'untuk anggota imam');
...
--
-- Struktur dari tabel `tbl_jadwalpiket`
--

CREATE TABLE `tbl_jadwalpiket` (
  `id_jadwalpiket` int(11) NOT NULL,
  `id_petugas` char(6) NOT NULL,
  `judul` varchar(200) NOT NULL,
  `jam_awal` time NOT NULL,
  `jam_akhir` time NOT NULL,
...
--
-- Indeks untuk tabel `tbl_jadwalpiket`
--
ALTER TABLE `tbl_jadwalpiket`
  ADD PRIMARY KEY (`id_jadwalpiket`);
...
--
-- AUTO_INCREMENT untuk tabel `tbl_jadwalpiket`
--
ALTER TABLE `tbl_jadwalpiket`
  MODIFY `id_jadwalpiket` int(11) NOT NULL AUTO_INCREMENT;
